...
export class CheckoutComponent implements OnInit {
    ...
    this.checkoutFormGroup = this.formBuilder.group({
      customer: this.formBuilder.group({
        ...
        email: new FormControl(theEmail,
          [Validators.required, Validators.pattern('^[A-Za-z0-9._%+-]+@[A-Za-z0-9._]+\\.[A-Za-z]{2,4}$')]
        )
      }),
  ...
  get creditCardNameOnCard() { return this.checkoutFormGroup.get('creditCard.cardNameOnCard'); }
